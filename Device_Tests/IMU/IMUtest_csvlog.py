...
iteration = 1500 #number of logged measurse
InitData = [] 
...
#name of file is current date and time 
	...
	praefix = raw_input("Richtung: ")
	fileName = str(sensorName)+'_'+str(time.strftime("%y%m%d"))+'_'+str(time.strftime("%H%M%S")+str(praefix)+'.csv'
...
# Register
power_mgmt_1 = 0x6b #this is used
power_mgmt_2 = 0x6c
...
# InitData.append((now, beschleunigung_xout_skaliert, beschleunigung_yout_skaliert))
 # = str(data)
